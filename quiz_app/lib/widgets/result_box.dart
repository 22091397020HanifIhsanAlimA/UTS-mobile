...
class ResultBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      backgroundColor: background , // Warna latar belakang kotak hasil kuis
      content: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              result == questionLength / 2
                  ? 'Tingkatkan lagi lagi' // Pesan tambahan jika nilai benar hanya setengah dari soal
                  : result < questionLength / 2
                      ? 'Bisa Belajar lagi' // Pesan tambahan jika nilai benar kurang dari setengah dari soal
                      : 'Bagus', // Pesan tambahan jika nilai benar lebih dari setengah dari soal
